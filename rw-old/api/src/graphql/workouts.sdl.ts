export const schema = gql`
  ...
  type Mutation {
    ...
    createWorkoutTemplate(input: WorkoutTemplateInput!): WorkoutTemplate! @requireAuth
    updateWorkoutTemplate(id: Int!, input: WorkoutTemplateInput!): WorkoutTemplate! @requireAuth
