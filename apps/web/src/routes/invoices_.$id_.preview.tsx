...
export const Route = createFileRoute("/invoices_/$id_/preview")({
  component: Component,
});
...
function Component() {
  ...
  return (
    <div className="mx-auto flex min-h-dvh max-w-5xl flex-col justify-between bg-white p-8 text-sm print:max-w-full print:p-0">
