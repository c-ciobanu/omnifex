...
const InvoicePreviewPage = ({ id }: InvoicePreviewProps) => {
  ...
  return invoice ? (
    <>
      ...
      <div className="mx-auto min-h-dvh max-w-screen-lg space-y-8 bg-white p-6 print:max-w-full print:p-0">
        ...
        <div className="flex justify-between">
          ...
          <fieldset className="grid grid-cols-[auto_14rem] content-start items-center gap-2">
