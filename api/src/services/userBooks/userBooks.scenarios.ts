import type { Prisma, Book, User, FavoritedBook, ReadBook, ToReadBook } from '@prisma/client'

export const favorited = defineScenario<Prisma.BookCreateArgs | Prisma.UserCreateArgs | Prisma.FavoritedBookCreateArgs>(
  {
    book: {
      cleanCode: {
        data: {
...
export const read = defineScenario<
  Prisma.BookCreateArgs | Prisma.UserCreateArgs | Prisma.ReadBookCreateArgs | Prisma.ToReadBookCreateArgs
>({
  book: {
    cleanCode: {
      data: {
...
export const toRead = defineScenario<
